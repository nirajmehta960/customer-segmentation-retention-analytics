"""
Run the SQL-first ETL pipeline (SQLite) for this project.

This executes SQL scripts in sql/etl/ in lexical order against a SQLite DB.
It assumes you've already loaded the raw data into a table named `online_retail`.
"""
